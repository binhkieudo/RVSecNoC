...
HD_PWD='/home/binhkieudo/Workspace/RISC-V/RVSecNoC/neorv32_verilog/mul/mul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rv32_fastalu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rv32_fastalu.tcl
