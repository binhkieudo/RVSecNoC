...
HD_PWD='/home/binhkieudo/Workspace/RISC-V/RVSecNoC/neorv32_verilog/mul/mul.runs/vio_alu_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vio_alu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vio_alu.tcl
