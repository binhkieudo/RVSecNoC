...
HD_PWD='/home/binhkieudo/Workspace/RVSecNoC/neorv32_verilog/multithread/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rv32_cpu_regfile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rv32_cpu_regfile.tcl
