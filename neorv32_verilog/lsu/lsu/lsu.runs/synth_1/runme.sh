...
HD_PWD='/home/binhkieudo/Workspace/RISC-V/RVSecNoC/neorv32_verilog/lsu/lsu/lsu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vtop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vtop.tcl
