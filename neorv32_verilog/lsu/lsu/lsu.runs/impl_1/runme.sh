...
HD_PWD='/home/binhkieudo/Workspace/RISC-V/RVSecNoC/neorv32_verilog/lsu/lsu/lsu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vtop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vtop.tcl -notrace
