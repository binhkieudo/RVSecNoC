...
HD_PWD='/home/binhkieudo/Workspace/RVSecNoC/neorv32_verilog/neorv32/neorv32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_test.tcl -notrace
